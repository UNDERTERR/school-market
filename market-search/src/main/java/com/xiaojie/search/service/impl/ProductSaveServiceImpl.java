...
import com.xiaojie.search.service.ProductSaveService;
...
public class ProductSaveServiceImpl implements ProductSaveService {
    ...
    public boolean saveProductAsIndices(List<SkuESModel> skuEsModels) throws IOException {
        ...
        BulkResponse bulkResponse = restHighLevelClient.bulk(bulkRequest, MarketElasticSearchConfig.COMMON_OPTIONS);
