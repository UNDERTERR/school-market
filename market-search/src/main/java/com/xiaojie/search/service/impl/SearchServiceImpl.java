...
import com.xiaojie.search.configuration.MarketElasticSearchConfig;
import com.xiaojie.search.feign.ProductFeignService;
import com.xiaojie.search.service.SearchService;
import com.xiaojie.search.vo.AttrResponseVo;
...
import com.xiaojie.search.constant.ESConstant;
...
public class SearchServiceImpl implements SearchService {
    ...
    public SearchResult getSearchResult(SearchParam searchParam) {
        ...
        try {
            SearchResponse searchResponse = restHighLevelClient.search(request, MarketElasticSearchConfig.COMMON_OPTIONS);
